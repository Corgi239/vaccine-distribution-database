...
WHERE VaccinationShift.worker = StaffMember.ssNo AND VaccinationShift.location = MedicalFacility.name AND MedicalFacility.address = "Helsinki" AND VaccinationShift.weekday = "Wednesday"
